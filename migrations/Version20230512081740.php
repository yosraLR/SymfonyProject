...
final class Version20230512081740 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE giveaways (id INT AUTO_INCREMENT NOT NULL, organisator_id_id INT NOT NULL, name VARCHAR(255) NOT NULL, start_date DATE NOT NULL, end_date DATE NOT NULL, INDEX IDX_EA70BD5D6F65CED5 (organisator_id_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE giveaways ADD CONSTRAINT FK_EA70BD5D6F65CED5 FOREIGN KEY (organisator_id_id) REFERENCES users (id)');
